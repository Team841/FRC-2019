...
public class OI {
    ...
    public JoystickButton setElevatorUp;
    public JoystickButton setElevatorDown;
    ...
    public OI() {
        ...
        setElevatorDown = new JoystickButton(coDriver, 1);
        setElevatorDown.whenPressed(new SetElevatorHeight(0));
        setElevatorUp = new JoystickButton(coDriver, 1);
        setElevatorUp.whenPressed(new SetElevatorHeight(0));
