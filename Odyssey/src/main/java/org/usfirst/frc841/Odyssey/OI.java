...
public class OI {
    ...
    public JoystickButton goTarget;
    ...
    public JoystickButton succDisable;
    public JoystickButton spootDisable;
    ...
    public OI() {
        ...
        spootDisable = new JoystickButton(coDriver, 4);
        spootDisable.whenReleased(new cargoSTOP());
        succDisable = new JoystickButton(coDriver, 3);
        succDisable.whenReleased(new cargoSTOP());
        ...
        goTarget = new JoystickButton(driver, 5);
        goTarget.whileHeld(new TurnToTarget());
